...
public class HttpImageManager{
    ...
    public static final Uri DEFAULT_BOOK_THUMB = Uri.parse("default.book.thumbnail");
    ...
    public static class LoadRequest {
        ...
        public LoadRequest(Drawable drawable, ImageView v) {
            if(drawable == null) 
                throw new NullPointerException("drawable must not be null");

            mUri = DEFAULT_BOOK_THUMB;
            mHashedUri = computeHashedName(mUri.toString());
            mImageView = v;
            mListener = null;
        }
